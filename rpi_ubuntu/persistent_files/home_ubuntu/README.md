...
This is the `/home/sysusr` directory. Files in this directory will be installed during setup, and the default ...

## Defaults

### .ansible.cfg

The default ansible.cfg, as of 2021-11-28, was:
...
all:
  hosts:
    this_rpi:
      ...
      # Users
      ssh_group: allow_ssh_logins  # goes to 'allow_and_deny.conf'
      admins:  # will be added to "users" and "sudo"
        - name: scam_likely
          shell: bash  # if it's not installed, install
      users:  # will be added to "users"
        - name: toofer_dentist
          shell: bash
        - name: stitch_mcgoo
          shell: sh
        ...
        - name: gar_bage
          shell: zsh
      devices:  # will be added to group "devices"
        - name: device1
          shell: /bin/bash
          ssh_keys:  # if users have 'ssh_keys' then they will be added to the 'ssh_group'
          - "ssh-ed25519 AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA comment_here"
          - "ssh-rsa  comment_here"
        - name: device2
          shell: /bin/bash
          ssh_keys:
          - "ssh-ed25519 BBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBB comment_here"
          - "ssh-rsa  comment_here"
